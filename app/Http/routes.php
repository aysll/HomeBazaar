...
Route::get('/blogsingle/{id}', 'pageController@blogSinglePage');
Route::get('/delivery', 'pageController@deliveryPage');
Route::get('/offers', 'pageController@offersPage');
Route::get('/shopsidebarall', 'pageController@shopSideBarPageAll');
Route::get('/shopsidebar/{id}', 'pageController@shopSideBarPage');
Route::get('/shopsingle/{id}', 'pageController@shopSinglePage');
